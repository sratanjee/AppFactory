...
- **Google Play (Production v2)** — 2026-09-18 22:53 UTC — versionCode 2 with branded launcher icon promoted, 20% US rollout, in Google review. Superseded v1 which was rejected as debug-signed then re-uploaded with keystore.
